...
def check_specific_signals():
    ...
    for target_time in target_times:
        ...
        if target_row['signal'] == 0:
            if not target_row['ma_above_mid'] and not target_row['ma_below_mid']:
                print(f"    原因: MA192与BOLL中轨关系不明确")
            elif not target_row['cross_above_ma'] and not target_row['cross_below_ma']:
                print(f"    原因: 没有发生穿越")
