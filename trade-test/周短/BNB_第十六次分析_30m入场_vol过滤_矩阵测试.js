/**
 * BNB 第十六次分析: 纯30m回测 + 波动率阈值过滤 + 矩阵测试
...
// 加载30m数据
console.log("加载数据...");
const df = loadCSV('../../../data_2026-08-13/kline_30m_202608141530_BNB.csv', 'open_time');
...
// 矩阵测试参数
const hardStops = [1.0, 1.5, 2.0, 2.5]; // BNB
const activates = [2, 3, 4, 5, 6];
const callbacks = [1, 2, 3, 4];
const VOL_THRESHOLD = 0.488; // BNB
