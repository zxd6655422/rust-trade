/**
 * SUI 第十六次分析: 纯30m回测 + 波动率阈值过滤 + 矩阵测试
...
// 加载30m数据
console.log("加载数据...");
const df = loadCSV('../data_2026-08-13/kline_30m_202608141533_SUI.csv', 'open_time');
...
// 矩阵测试参数
const hardStops = [1.5, 2.0, 2.5, 3.0]; // SUI
const activates = [2, 3, 4, 5, 6];
const callbacks = [1, 2, 3, 4];
const VOL_THRESHOLD = 0.788; // SUI
