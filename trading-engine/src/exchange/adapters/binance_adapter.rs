...
#[async_trait]
impl trading_common::data::account_types::AccountProvider for BinanceAdapter {
    async fn get_account_snapshot(
        ...
        Ok(trading_common::data::account_types::AccountSnapshot {
            ...
            total_equity: account.total_margin_balance,
            total_balance: account.total_wallet_balance,
            available_balance: account.account_info.available_balance,
            frozen_balance: account.total_wallet_balance - account.account_info.available_balance,
    ...
    async fn get_asset_balances(
        ...
        Ok(account.account_info.balances.iter().map(|b| {
...
impl crate::exchange::traits::Exchange for BinanceAdapter {
